...
function mostrarDatosDeCivilizacion(civTxt){
    // recibe un texto con el nombre de la civ, y busca un objeto que se llame así
    ...
    civ.descripcion.forEach(texto => {
        i++;   // para el contador de páginas
        let textoCompleto = "(" + i + " de " + civ.descripcion.length + ") " + texto ;
        alert(textoCompleto);
    });
}
